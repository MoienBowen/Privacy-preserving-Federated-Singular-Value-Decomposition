...
/**
 * Wrapper to the key generation function using stdio streams as inputs and
 * output.
 * @see paillier_keygen
 */
...
/**
 * Wrapper to the homomorphic addition function using stdio streams as inputs
 * and output.
...
/**
 * Wrapper to the homomorphic multiplication function using stdio streams as
 * inputs and output.
 * @see paillier_homomorphic_add
 */
int paillier_homomorphic_multc_str(FILE *ciphertext2, FILE *ciphertext1,
                                   FILE *constant, FILE *public_key) {
  mpz_t c2, c1, k, n2;
  paillier_public_key pub;
  int result;
