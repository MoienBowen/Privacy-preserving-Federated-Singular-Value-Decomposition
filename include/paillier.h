 ...
 * @ingroup Paillier
 *
 * The generator is 1+n. This is fine in view of security because Class[g,n] is
 * random self-reducible over g, therefore the security of the cryptosystem does
 ...
 *
 * @ingroup Paillier
 * @param[out] ciphertext3 output ciphertext corresponding to the homomorphic
 * addition of the two plaintexts
 * @param[in] ciphertext1 input first ciphertext corresponding to a plaintext to
 * be homomorphically added
 * @param[in] ciphertext2 input second ciphertext corresponding to a plaintext
 * to be homomorphically added
 * @param[in] pub input public key
 * @return 0 if no error
 */
 ...
 * @return 0 if no error
 */
int paillier_homomorphic_add_str(FILE *ciphertext3, FILE *ciphertext1,
                                 FILE *ciphertext2, FILE *public_key);

/** Homomorphically multiply a plaintext with a constant
 *
 * @ingroup Paillier
 * @param[out] ciphertext2 output ciphertext corresponding to the homomorphic
 * multiplication of the plaintext with the constant
 * @param[in] ciphertext1 input ciphertext corresponding to a plaintext to be
 ...
 *
 * @ingroup Paillier
 * @param[out] ciphertext2 output stream for result of homomorphic
 * multiplication
 ...
 * @return 0 if no error
 */
int paillier_homomorphic_multc_str(FILE *ciphertext2, FILE *ciphertext1,
                                   FILE *plaintext, FILE *public_key);
